package com.lambdaschool.fishfriends.logging;
...
{
    @Around(value = "@within(com.lambdaschool.fishfriends.logging.Loggable) || @annotation(com.lambdaschool.fishfriends.logging.Loggable)")
